...
public class OrderItemDetails implements DomainObject {
	 ...
	 */
	public static class OrderItemDetailsBuilder<BLDRT extends GenericBuilder>extends
	NestedBuilder<OrderItemDetails, BLDRT>{
	     ...
	     */
		public final OrderItemDetailsBuilder<BLDRT>preOrderItemAvailabilityDate(final String preOrderItemAvailabilityDate){
	     ...
	     * @return OrderItemDetailsBuilder
	     */
		public final OrderItemDetailsBuilder<BLDRT>preOrderPurchaseIndicator(final PreOrderPurchaseIndicator preOrderPurchaseIndicator){
	     ...
	     * @return OrderItemDetailsBuilder
	     */
		public final OrderItemDetailsBuilder<BLDRT>reorderItemsIndicator(final ReorderItemsIndicator reorderItemsIndicator){
