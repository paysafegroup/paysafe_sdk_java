...
public class UserAccountDetails implements DomainObject {
	 ...
	 */
	public static class UserAccountDetailsBuilder<BLDRT extends GenericBuilder>extends 
	NestedBuilder<UserAccountDetails, BLDRT>{
		...
		public final ShippingDetailsUsage.ShippingDetailsUsageBuilder<UserAccountDetailsBuilder<BLDRT>>shippingDetailsUsage(){
			if(null==shippingDetailsUsageBuilder){
				shippingDetailsUsageBuilder=new ShippingDetailsUsage.ShippingDetailsUsageBuilder<UserAccountDetailsBuilder<BLDRT>>(this);
			}
		...
		public final PaymentAccountDetails.PaymentAccountDetailsBuilder<UserAccountDetailsBuilder<BLDRT>>paymentAccountDetails(){
			if(null==paymentAccountDetailsBuilder){
				paymentAccountDetailsBuilder=new PaymentAccountDetails.PaymentAccountDetailsBuilder<UserAccountDetailsBuilder<BLDRT>>(this);
			}
		...
		public final PriorThreeDSAuthentication.PriorThreeDSAuthenticationBuilder<UserAccountDetailsBuilder<BLDRT>>priorThreeDSAuthentication(){
			if(null==priorThreeDSAuthenticationBuilder){
				priorThreeDSAuthenticationBuilder=new PriorThreeDSAuthentication.PriorThreeDSAuthenticationBuilder<UserAccountDetailsBuilder<BLDRT>>(this);
			}
	     ...
	     * @return UserAccountDetailsBuilder
	     */
		public final UserAccountDetailsBuilder<BLDRT> passwordChangedRange(final PasswordChangedRange passwordChangedRange){
	     ...
	     * @return UserAccountDetailsBuilder
	     */
		public final UserAccountDetailsBuilder<BLDRT> totalPurchasesSixMonthCount(final Integer totalPurchasesSixMonthCount){
	     ...
	     * @return UserAccountDetailsBuilder
	     */
		public final UserAccountDetailsBuilder<BLDRT> addCardAttemptsForLastDay(final Integer addCardAttemptsForLastDay){
	     ...
	     * @return UserAccountDetailsBuilder
	     */
		public final UserAccountDetailsBuilder<BLDRT> transactionCountForPreviousDay(final Integer transactionCountForPreviousDay){
	     ...
	     * @return UserAccountDetailsBuilder
	     */
		public final UserAccountDetailsBuilder<BLDRT> transactionCountForPreviousYear(final Integer transactionCountForPreviousYear){
	     ...
	     * @return UserAccountDetailsBuilder
	     */
		public final UserAccountDetailsBuilder<BLDRT> suspiciousAccountActivity(final Boolean suspiciousAccountActivity){
