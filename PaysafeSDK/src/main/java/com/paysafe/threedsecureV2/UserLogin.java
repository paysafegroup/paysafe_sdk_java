...
public class UserLogin implements DomainObject{
	...
	/**
	   ...
	   *
	   * @param authenticationMethod the new authenticationMethod
	   */
	 ...
	 */
	public static class UserLoginBuilder<BLDRT extends GenericBuilder>extends 
	NestedBuilder<UserLogin, BLDRT>{
